...
const authSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(registerUser.fulfilled, (state) => { state.isLoading = false, state.isAuthenticated = false, state.user = null })
      .addCase(registerUser.rejected, (state) => { state.isLoading = false, state.isAuthenticated = false, state.user = null })
      .addCase(loginUser.pending, (state) => { state.isLoading = true})
      .addCase(loginUser.fulfilled, (state,action) => { state.isLoading = false, state.isAuthenticated =action.payload.success , state.user = action.payload.user ? action.payload.user : null })
